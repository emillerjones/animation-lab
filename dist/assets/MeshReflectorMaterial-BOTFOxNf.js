import{_ as te}from"./extends-CF3RwP-h.js";import{r as a}from"./index-BMA-JQyv.js";import{S as re,e as P,_ as ae,aD as u,W as H,H as Y,L as W,w as ie,dO as oe,ah as ne,B as G,M as se,at as le,P as ue,V as w,g as X,a6 as q,ao as fe,bw as me,bF as he,o as ve}from"./three.module-4i5VD4Ag.js";import{v as ce}from"./constants-lYLjsJcj.js";import{e as de,a as N,u as pe}from"./react-three-fiber.esm-Xnp3vs9C.js";class xe extends re{constructor(e=new P){super({uniforms:{inputBuffer:new u(null),depthBuffer:new u(null),resolution:new u(new P),texelSize:new u(new P),halfTexelSize:new u(new P),kernel:new u(0),scale:new u(1),cameraNear:new u(0),cameraFar:new u(1),minDepthThreshold:new u(0),maxDepthThreshold:new u(1),depthScale:new u(0),depthToBlurRatioBias:new u(.25)},fragmentShader:`#include <common>
