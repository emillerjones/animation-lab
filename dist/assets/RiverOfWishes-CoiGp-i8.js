import{r as u,j as t}from"./index-C142NzQa.js";import{C as se,u as ne}from"./CanvasStage-Bb_NoSnX.js";import{u as ce}from"./useDragOrbit-CGhNynaS.js";import{u as le}from"./usePinchZoom-BIgCu2mb.js";import{A as ue}from"./AnimationReadout-rODen0We.js";import{s as g}from"./procedural-DZUg-xN7.js";import{a as he,u as de}from"./react-three-fiber.esm-CSqyKp3t.js";import{ad as q,aa as K,D as ve,V as $,a9 as pe,ai as Q,dO as me,l as fe,R as ge,F as xe,N as ee,aG as V,a7 as we,a5 as C,aF as ae}from"./three.module-Ct-yBmsu.js";import"./index-HVhEDPQQ.js";import"./quality-NEVBGrgs.js";import"./dragOrbit-BWBT6NeL.js";const be=1e5,ye=2500,Se="(hover: none), (pointer: coarse)",I=512,te=.87,Re=[{position:[-18,0,14],color:"#ffd18a"},{position:[18,0,14],color:"#ffc078"},{position:[18,0,-16],color:"#ffe0a0"},{position:[-18,0,-16],color:"#ffb96e"}],re="#090d20",Pe=.58,je=.85;function oe(o,r){const e=Math.abs(o-r)%1;return Math.min(e,1-e)}function Me(o){const r=oe(o,Pe),e=oe(o,je),i=1+Math.exp(-(e**2)/(2*.05**2))-.55*Math.exp(-(r**2)/(2*.035**2));return q.clamp(i,.4,2.1)}function Te(){const o=[],r=[],e=(m,v,T,R)=>{o.push(...v,...T,...R),r.push(m,m,m)},i=[0,.58,.02],a=[0,-.14,.02],s=[-.48,.2,.02],l=[.48,.2,.02],d=[0,.22,.7],b=[0,.22,-.68];e(0,i,s,d),e(0,i,d,l),e(0,i,l,b),e(0,i,b,s),e(0,a,d,s),e(0,a,l,d),e(0,a,b,l),e(0,a,s,b);const S=[-.13,.24,.58],j=[.13,.24,.58],x=[-.1,.82,1.05],L=[.1,.82,1.05],n=[-.09,1.25,1.38],w=[.09,1.25,1.38];e(0,S,j,L),e(0,S,L,x),e(0,x,L,w),e(0,x,w,n);const M=[0,1.38,1.53],p=[0,1.18,1.6],y=[0,1.03,2.02];e(0,n,w,M),e(0,n,p,w),e(0,M,w,y),e(0,M,y,n),e(0,n,y,p),e(0,p,y,w);const G=[-.06,.24,-.57],Y=[.06,.24,-.57],U=[-.035,.58,-1],O=[.035,.58,-1],z=[0,.82,-1.55];e(0,G,Y,O),e(0,G,O,U),e(0,U,O,z);function B(m,v){const T=[.08*m,.48,.5],R=[.08*m,.48,-.48],A=[.82*m,.42,.62],k=[.92*m,.4,-.62],F=[2.12*m,.18,-.04],f=[1*m,.66,.02];m>0?(e(v,T,A,f),e(v,A,F,f),e(v,f,F,k),e(v,f,k,R),e(v,T,f,R)):(e(v,T,f,A),e(v,A,f,F),e(v,f,k,F),e(v,f,R,k),e(v,T,R,f))}B(-1,1),B(1,2);const H=new pe;return H.setAttribute("position",new Q(o,3)),H.setAttribute("aHingeGroup",new Q(r,1)),H.computeVertexNormals(),H}const Ae=[[-24,10.2,18],[-19,11.2,23],[-12,10.4,18],[-7,9.4,9],[0,10.3,14],[9,11.4,21],[18,10.7,20],[24,10.1,14],[19,11.1,8],[10,10.3,4],[15,9.5,-2],[24,10.4,-9],[23,11.3,-17],[18,10.6,-23],[10,9.6,-18],[5,10.5,-9],[0,11.6,-14],[-9,12.1,-23],[-18,10.8,-22],[-24,9.7,-16],[-21,10.5,-8],[-12,11.4,-4],[-17,10.7,2],[-25,10.1,9]];function Fe(){const o=Ae.map(s=>new $(s[0]*te,s[1],s[2]*te)),r=new me(o,!0,"catmullrom",.5),e=r.getPoints(I),i=new Float32Array(I*4);for(let s=0;s<I;s+=1){const l=e[s];i[s*4]=l.x,i[s*4+1]=l.y,i[s*4+2]=l.z,i[s*4+3]=Me(s/I)}const a=new fe(i,I,1,ge,xe);return a.needsUpdate=!0,a.minFilter=ee,a.magFilter=ee,a.wrapS=V,{curve:r,texture:a}}function Ce(){const r=document.createElement("canvas");r.width=256,r.height=256;const e=r.getContext("2d");e.fillStyle="#3f2c1a",e.fillRect(0,0,256,256);for(let a=0;a<70;a+=1){const s=a*3.6+g(a,701)*3;e.strokeStyle=`rgba(20, 12, 6, ${.12+g(a,702)*.22})`,e.lineWidth=1+g(a,703)*2,e.beginPath();for(let l=0;l<=256;l+=12){const d=Math.sin(l*.03+a)*4;l===0?e.moveTo(l,s+d):e.lineTo(l,s+d)}e.stroke()}const i=new ae(r);return i.wrapS=V,i.wrapT=V,i.repeat.set(1,4),i}function Le(){const r=document.createElement("canvas");r.width=512,r.height=512;const e=r.getContext("2d");e.fillStyle="#5a5650",e.fillRect(0,0,512,512);for(let a=0;a<300;a+=1){const s=g(a,801)*512,l=g(a,802)*512;e.fillStyle=`rgba(30, 28, 24, ${.06+g(a,803)*.1})`,e.beginPath(),e.arc(s,l,1+g(a,804)*2.5,0,Math.PI*2),e.fill()}const i=new ae(r);return i.wrapS=V,i.wrapT=V,i}function ze(o,{pathTexture:r,flowSpeedMul:e,riverWidthMul:i,wingFlutter:a}){o.uniforms.uPathTexture={value:r},o.uniforms.uTime={value:0},o.uniforms.uFlowSpeed={value:e},o.uniforms.uRiverWidth={value:i},o.uniforms.uWingFlutter={value:a},o.vertexShader=o.vertexShader.replace("#include <common>",`
