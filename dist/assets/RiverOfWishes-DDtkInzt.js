import{r as u,j as t}from"./index-Cn8Qt7KI.js";import{C as ne,u as ce}from"./CanvasStage-DVb1S5Le.js";import{u as le}from"./useDragOrbit-TXycjBEy.js";import{u as ue}from"./usePinchZoom-BVlVLdUv.js";import{A as he}from"./AnimationReadout-Cd7KDS-4.js";import{s as g}from"./procedural-DZUg-xN7.js";import{a as de,u as ve}from"./react-three-fiber.esm-B6NcoU1E.js";import{ad as $,aa as K,D as pe,V as Z,a9 as me,ai as ee,dO as fe,l as ge,R as xe,F as we,N as te,aG as V,a7 as be,a5 as F,aF as se}from"./three.module-Ct-yBmsu.js";import"./index-Ds-CAf7A.js";import"./quality-NEVBGrgs.js";import"./dragOrbit-BWBT6NeL.js";const ye=1e5,Se=2500,Re="(hover: none), (pointer: coarse)",q=1,I=512,re=.87,Pe=[{position:[-18,0,14],color:"#ffd18a"},{position:[18,0,14],color:"#ffc078"},{position:[18,0,-16],color:"#ffe0a0"},{position:[-18,0,-16],color:"#ffb96e"}],oe="#090d20",Te=.58,je=.85;function ae(o,r){const e=Math.abs(o-r)%1;return Math.min(e,1-e)}function Me(o){const r=ae(o,Te),e=ae(o,je),s=1+Math.exp(-(e**2)/(2*.05**2))-.55*Math.exp(-(r**2)/(2*.035**2));return $.clamp(s,.4,2.1)}function Ae(){const o=[],r=[],e=(m,v,M,R)=>{o.push(...v,...M,...R),r.push(m,m,m)},s=[0,.58,.02],a=[0,-.14,.02],i=[-.48,.2,.02],l=[.48,.2,.02],d=[0,.22,.7],b=[0,.22,-.68];e(0,s,i,d),e(0,s,d,l),e(0,s,l,b),e(0,s,b,i),e(0,a,d,i),e(0,a,l,d),e(0,a,b,l),e(0,a,i,b);const S=[-.13,.24,.58],T=[.13,.24,.58],x=[-.1,.82,1.05],L=[.1,.82,1.05],n=[-.09,1.25,1.38],w=[.09,1.25,1.38];e(0,S,T,L),e(0,S,L,x),e(0,x,L,w),e(0,x,w,n);const j=[0,1.38,1.53],p=[0,1.18,1.6],y=[0,1.03,2.02];e(0,n,w,j),e(0,n,p,w),e(0,j,w,y),e(0,j,y,n),e(0,n,y,p),e(0,p,y,w);const G=[-.06,.24,-.57],Y=[.06,.24,-.57],U=[-.035,.58,-1],H=[.035,.58,-1],z=[0,.82,-1.55];e(0,G,Y,H),e(0,G,H,U),e(0,U,H,z);function _(m,v){const M=[.08*m,.48,.5],R=[.08*m,.48,-.48],A=[.82*m,.42,.62],k=[.92*m,.4,-.62],C=[2.12*m,.18,-.04],f=[1*m,.66,.02];m>0?(e(v,M,A,f),e(v,A,C,f),e(v,f,C,k),e(v,f,k,R),e(v,M,f,R)):(e(v,M,f,A),e(v,A,f,C),e(v,f,k,C),e(v,f,R,k),e(v,M,R,f))}_(-1,1),_(1,2);const O=new me;return O.setAttribute("position",new ee(o,3)),O.setAttribute("aHingeGroup",new ee(r,1)),O.computeVertexNormals(),O}const Ce=[[-24,10.2,18],[-19,11.2,23],[-12,10.4,18],[-7,9.4,9],[0,10.3,14],[9,11.4,21],[18,10.7,20],[24,10.1,14],[19,11.1,8],[10,10.3,4],[15,9.5,-2],[24,10.4,-9],[23,11.3,-17],[18,10.6,-23],[10,9.6,-18],[5,10.5,-9],[0,11.6,-14],[-9,12.1,-23],[-18,10.8,-22],[-24,9.7,-16],[-21,10.5,-8],[-12,11.4,-4],[-17,10.7,2],[-25,10.1,9]];function Fe(){const o=Ce.map(i=>new Z(i[0]*re,i[1],i[2]*re)),r=new fe(o,!0,"catmullrom",.5),e=r.getPoints(I),s=new Float32Array(I*4);for(let i=0;i<I;i+=1){const l=e[i];s[i*4]=l.x,s[i*4+1]=l.y,s[i*4+2]=l.z,s[i*4+3]=Me(i/I)}const a=new ge(s,I,1,xe,we);return a.needsUpdate=!0,a.minFilter=te,a.magFilter=te,a.wrapS=V,{curve:r,texture:a}}function Le(){const r=document.createElement("canvas");r.width=256,r.height=256;const e=r.getContext("2d");e.fillStyle="#3f2c1a",e.fillRect(0,0,256,256);for(let a=0;a<70;a+=1){const i=a*3.6+g(a,701)*3;e.strokeStyle=`rgba(20, 12, 6, ${.12+g(a,702)*.22})`,e.lineWidth=1+g(a,703)*2,e.beginPath();for(let l=0;l<=256;l+=12){const d=Math.sin(l*.03+a)*4;l===0?e.moveTo(l,i+d):e.lineTo(l,i+d)}e.stroke()}const s=new se(r);return s.wrapS=V,s.wrapT=V,s.repeat.set(1,4),s}function ze(){const r=document.createElement("canvas");r.width=512,r.height=512;const e=r.getContext("2d");e.fillStyle="#5a5650",e.fillRect(0,0,512,512);for(let a=0;a<300;a+=1){const i=g(a,801)*512,l=g(a,802)*512;e.fillStyle=`rgba(30, 28, 24, ${.06+g(a,803)*.1})`,e.beginPath(),e.arc(i,l,1+g(a,804)*2.5,0,Math.PI*2),e.fill()}const s=new se(r);return s.wrapS=V,s.wrapT=V,s}function ke(o,{pathTexture:r,flowSpeedMul:e,riverWidthMul:s,wingFlutter:a}){o.uniforms.uPathTexture={value:r},o.uniforms.uTime={value:0},o.uniforms.uFlowSpeed={value:e},o.uniforms.uRiverWidth={value:s},o.uniforms.uWingFlutter={value:a},o.vertexShader=o.vertexShader.replace("#include <common>",`
