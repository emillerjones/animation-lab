...
export default function InfiniteLibrary({ settings = {} }) {
  return <GpuExperience scene="infinite-library" World={InfiniteLibraryWorld} settings={settings} accent="#e4b56f" background="#050301" eyebrow="11 — Endless archive" title={"Every aisle\nholds another world."} description="Book-filled galleries, timber vaults, and pools of reading light repeat beyond sight." />;
}
