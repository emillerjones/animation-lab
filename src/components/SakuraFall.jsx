...
export default function SakuraFall({ settings = {} }) {
  ...
  return (
    <section className="atmosphere sakura-fall">
      ...
      <div className="experiment-copy"><p>14 — Petal study</p><h1>Spring, letting<br />go slowly.</h1><span>Cherry-blossom petals spiral down through soft morning light, tumbling on the air.</span></div>
